                              ...
                              child: Container(
                                ...
                                child: SingleChildScrollView(
                                  child: Column(
                                    children: [
                                      Text(
                                          '${state.allCollegesModel.data.list[index].name}'),
                                      Text(
                                          '${state.allCollegesModel.data.list[index].address}'),
                                      Text(
                                          '${state.allCollegesModel.data.list[index].phoneNumber}'),
                                      Text(
                                          '${state.allCollegesModel.data.list[index].regionName}'),
                                      Text(
                                          '${state.allCollegesModel.data.list[index].ownershipName}'),
                                    ],
                                  ),
                                ),
                              ),
